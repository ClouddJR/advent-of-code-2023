...
f = open(f"../src/main/kotlin/com/clouddjr/advent2023/Day{day}.kt", "w")
fileContent = f'''package com.clouddjr.advent2023
...
f = open(f"../src/test/kotlin/com/clouddjr/advent2023/Day{day}Test.kt", "w")
fileContent = f'''package com.clouddjr.advent2023

import com.clouddjr.advent2023.Resources.{loadResourceMethod}
...
res = requests.get(f"https://adventofcode.com/2023/day/{args.day}/input", cookies={'session': session})
